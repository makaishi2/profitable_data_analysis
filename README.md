...
| ソース | タイトル                               | リンク                                                 | 補足                                                 |
| ------ | -------------------------------------- | ------------------------------------------------------ | ---------------------------------------------------- |
| 日経BOOK PLUS | はじめに：『ChatGPTで儲かるデータ分析』                      | https://bookplus.nikkei.com/atcl/column/032900009/022700857/ | 本書のまえがきを全文掲載しています             |
| qiita  | タイタニック・データセットで決定木分析 | https://qiita.com/makaishi2/items/f41b7e46fc88b14e1238 | 序章の実習で結果のみ示されている決定木の解説記事です |
| Github | データサイエンティスト協会デモで利用した資材 | https://github.com/makaishi2/profitable_data_analysis/tree/main/ai_materials/EXTRA02 | 2025年4月24日(水)データサイエンティスト協会主催の講演で利用したでデモ資材です |

外部リンク

| ソース        | タイトル                                                     | リンク                                                      | 補足                                                         |
| ------------- | ------------------------------------------------------------ | ----------------------------------------------------------- | ------------------------------------------------------------ |
| 日経BOOK PLUS | からあげが推す「生成AI時代のデータ分析の新たな学習法を示す」一冊 | https://bookplus.nikkei.com/atcl/column/041100040/031100050 | 有名なブロガーである「からあげ」さんの書評です               |
| note          | 「ChatGPT で儲かるデータ分析」の続編を ChatGPT と Python で  | https://note.com/e_dao/n/n12223db09018                      | 「ネイピアDS」さんが、本書の8章の実習を深掘りした結果を記事にしていただきました |
