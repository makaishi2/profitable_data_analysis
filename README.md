...
### 巻末の講座で必要最小限のPythonプログラミング知識をコンパクトに集約

　生成AIにほとんど任せられるようになったとはいえ、Pythonのプログラミング知識をまったくなしにデータ分析を行うのは危険で、必要最小限の知識は必要です。著者は、**従来は「プログラムを自力でする能力」が必要**だったのに対して、**今後は「プログラムを読んで処理内容を理解できる能力」で十分**になったと考えています。

　本書は、**巻末の「講座」に約100ページかけてPythonプログラムの初歩からデータ処理の基本までをコンパクトに整理**しました。あわせて統計処理の初歩についてもまとめています。

　最初から体系立って学習するのにも、必要な箇所だけ辞書的に使うのもできる形になっていますので、Python学習の地図として活用して下さい。
